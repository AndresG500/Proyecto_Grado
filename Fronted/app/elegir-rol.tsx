    ...
    <SafeAreaView style={styles.root}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.cards}>
          <TouchableOpacity
            style={styles.card}
            onPress={() => router.push('/register-cuidador' as any)}
            activeOpacity={0.85}
          >
            ...
            <Text style={styles.cardDesc}>
              Cuid a pacientes con Alzheimer. Puedes agregar pacientes y crear zonas seguras.
            </Text>
          </TouchableOpacity>

          <TouchableOpacity
            style={[styles.card, styles.cardSecondary]}
            onPress={() => router.push('/register-familiar' as any)}
            activeOpacity={0.85}
          >
