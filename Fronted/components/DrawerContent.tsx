  ...
  return (
    <SafeAreaView style={styles.root}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.name} numberOfLines={1}>{cuidador?.name ?? 'Cuidador'}</Text>
...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 24, paddingTop: 48, paddingBottom: 24, alignItems: 'center' },
  avatar: { width: 68, height: 68, borderRadius: 34, backgroundColor: Colors.primary, justifyContent: 'center', alignItems: 'center', marginBottom: 14, borderWidth: 2, borderColor: Colors.primaryMid },
  avatarText: { fontSize: 28, fontWeight: '700', color: Colors.white },
  name:  { fontSize: 17, fontWeight: '700', color: Colors.drawerText, marginBottom: 3 },
  email: { fontSize: 12, color: Colors.drawerMuted, marginBottom: 12 },
  activeBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(16,185,129,0.15)', paddingHorizontal: 12, paddingVertical: 5, borderRadius: 20, gap: 6 },
  ...
  nav: { flex: 1, paddingHorizontal: 14, paddingTop: 16 },
  navItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 13, paddingHorizontal: 16, borderRadius: 14, marginBottom: 2 },
  navItemActive: { backgroundColor: Colors.drawerItem },
  navIcon:  { marginRight: 14 },
  navLabel: { flex: 1, fontSize: 14, fontWeight: '500', color: Colors.drawerMuted },
  navLabelActive: { color: Colors.drawerText, fontWeight: '700' },
  activeBar: { width: 4, height: 20, borderRadius: 2, backgroundColor: Colors.primary },

  footer:    { paddingBottom: 16 },
  logoutBtn: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, paddingHorizontal: 30, marginTop: 8 },
